...
create table ACT_RU_EXECUTION (
    ...
    IS_EVENT_SCOPE_ smallint check(IS_EVENT_SCOPE_ in (1,0)),
	  UNI_BUSINESS_KEY varchar (255)  not null,
...
CREATE TRIGGER ACT_RU_EXECUTION_BEFOREINSERT NO CASCADE BEFORE INSERT ON ACT_RU_EXECUTION REFERENCING NEW AS n FOR EACH ROW MODE DB2ROW
BEGIN ATOMIC
